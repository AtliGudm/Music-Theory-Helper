...
const DisplayPianoKeyboard = ({selectedScale, isSmallScreen, toggleFooter}:{selectedScale: PayloadContainer, isSmallScreen: boolean, toggleFooter: () => void}) => {
    const { showDisplayKeyboardDegrees, setShowDisplayKeyboardDegrees,
    ...
    return (
        <div className='container'>
            <div className='piano-display-border' style={{display: "flex"}} /* style={isSmallScreen ? {width: "307px"} : {width: "586px"}} */>
                <div style={{display: "flex", flexDirection: "column", justifyContent: "space-between", paddingInline: "6px", paddingBlock: "2px"}}>
                    <div style={{paddingRight: "0px"}}>
                            <i onClick={toggleFooter}
                                style={{fontSize: "18px"/* , color: "#ba0000" */}}
